...
* Fill in the following data:
    * Application Name: `Kafeniocoin Core`
    * Application Version: `1.2.0.0`
    * Application Publisher: `2022 Kafeniocoin Core Developers`
    * Application Website: `https://kafeniocoin.com/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `Kafeniocoin`
* Add application files:
    * Select the file `kafeniocoin-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `kfn-1.1.0-win64-setup.exe`
