...
DefaultDirName={autopf}\Kafeniocoin
...
OutputDir=.\output
OutputBaseFilename=KafeniocoinSetup
...
DefaultGroupName=Kafeniocoin Core
...
[Files]
Source: ".\package\kafeniocoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Kafeniocoin\Kafeniocoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Kafeniocoin\Kafeniocoin-Qt,strDataDir|{userappdata}\Kafeniocoin\}');
  Result := True;
end;
