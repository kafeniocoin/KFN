...
"""Verify that starting kafeniocoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kafeniocoin with -? for help text")
        ...
        self.log.info("Start kafeniocoin with -version for version information")
