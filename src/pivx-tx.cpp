...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Kafeniocoin kafeniocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kafeniocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kafeniocoin transaction") + "\n" +
                               "  kafeniocoin-tx [options] -create [commands]   " + _("Create hex-encoded kafeniocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kafeniocoin transaction
