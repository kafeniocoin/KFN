...
/* Kafeniocoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Kafeniocoin"
#define QAPP_ORG_DOMAIN "kafeniocoin.com"
#define QAPP_APP_NAME_DEFAULT "Kafeniocoin-Qt"
#define QAPP_APP_NAME_TESTNET "Kafeniocoin-Qt-testnet"
