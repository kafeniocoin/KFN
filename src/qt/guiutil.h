...
/** Utility functions used by the Kafeniocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render KFN addresses in monospace font
...
// Parse "kafeniocoin:" URI into recipient object, return true on successful parsing
