...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all KFN specific functionality (Masternodes) (0-1, default: %u)"), 0));
...
/** Sanity checks
 *  Ensure that Espium is running in a usable environment with all
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                //Kafeniocoin specific: spork DB's
