...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KFN features */
        {"kafeniocoin", "listmasternodes", &listmasternodes, true },
        {"kafeniocoin", "getmasternodecount", &getmasternodecount, true },
        {"kafeniocoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"kafeniocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
...
{
    return "> kafeniocoin-cli " + methodname + " " + args + "\n";
}
