Contributing to Kafeniocoin Core
============================

The Kafeniocoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/KafeniocoinBF/Kafeniocoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Kafeniocoin Core project, and is not to be
confused with overall Kafeniocoin Network Protocol consensus changes.

Whether a pull request is merged into Kafeniocoin Core rests with the project merge
...
Patches that change Kafeniocoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Kafeniocoin consensus, it must have been
...
The project leader is the release manager for each Kafeniocoin Core release.
